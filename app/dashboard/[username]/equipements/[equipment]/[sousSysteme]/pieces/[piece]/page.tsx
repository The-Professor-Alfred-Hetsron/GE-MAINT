                    ...
                    <div className="w-full px-4 flex-col justify-start items-start gap-2 inline-flex">
                        <div className="flex-col justify-start items-start inline-flex">
                            ...
                            <div className="justify-start items-center gap-[4px] inline-flex">
                                ...
                                <span className="text-black text-[20px] font-semibold">{piece.marque}</span>
                            </div>
                            <div className="justify-start items-center gap-[4px] inline-flex">
                                <span className="text-black text-[18px] font-normal leading-loose">Numéro de Série: </span>
                                <span className="text-black text-[20px] font-semibold">{piece.numSerie}</span>
                            </div>
                            <div className="justify-start items-center gap-[4px] inline-flex">
                                <span className="text-black text-[18px] font-normal leading-loose">Modèle: </span>
                                <span className="text-black text-[20px] font-semibold">{piece.modele}</span>
                            </div>
                            <div className="justify-start items-center gap-[4px] inline-flex">
                                <span className="text-black text-[18px] font-normal leading-loose">Localisation: </span>
                                <span className="text-black text-[20px] font-semibold">{piece.localisation}</span>
                            </div>
                            <div className="justify-start items-center gap-[4px] inline-flex">
                                <span className="text-black text-[18px] font-normal leading-loose">Quantité en Stock: </span>
                                <span className="text-black text-[20px] font-semibold">{piece.qteStock}</span>
                            </div>
                            <div className="justify-start items-center gap-[4px] inline-flex">
                                <span className="text-black text-[18px] font-normal leading-loose">Quantité Minimale: </span>
                                <span className="text-black text-[20px] font-semibold">{piece.qteMin}</span>
                            </div>
                            <div className="justify-start items-baseline gap-[4px] inline-flex">
                                ...
                                <span className="text-black text-[20px] font-semibold">{piece.description}</span>
                            </div>
                        </div>
                        <div className="w-full pr-2 flex flex-wrap gap-2 justify-start items-center">
                            ...
                            <button onClick={()=>deletePiece()} className='w-full px-4 py-2 justify-center items-center gap-2 inline-flex rounded-lg bg-white border border-[#34A853] text-[#34A853] hover:bg-[#34A853] hover:border-none hover:text-white'>
                                <AiOutlinePlus size={20}/>
                                <span className='text-[16px] font-semibold'>Ajouter en Stock</span>
                            </button>
                            <button onClick={()=>deletePiece()} className='w-full px-4 py-2 justify-center items-center gap-2 inline-flex rounded-lg bg-white border border-[#EDA92A] text-[#EDA92A] hover:bg-[#EDA92A] hover:border-none hover:text-white'>
